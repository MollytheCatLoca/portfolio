...
import ChatCompContact from './ChatCompContact';
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (data.success) {
                ...
                setSubmitterName(name); // Establecer el nombre del remitente
                setName('');
                setEmail('');
                setMessage('');
            } else {
...
{/* Componente ChatCompContact */ }
<ChatCompContact submitterName={ submitterName } />
    </div>
    );
}