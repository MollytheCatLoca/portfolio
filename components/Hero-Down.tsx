...
const Hero = () => {
    ...
    className = "absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black-100 bg - white[mask - image: radial - gradient(ellipse_at_center, transparent_20 %, black)]"
        ...
        < div className = "flex justify-center relative my-20 z-10" >
           ...
           */}
                < TextGenerateEffect
    words = "Centro de Recursos"
    className = "text-center text-[40px] md:text-5xl lg:text-6xl"
        />

        <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl" style = {{ color: 'white' }
} >
    Accede a nuestra biblioteca de presentaciones, informes técnicos y recursos especializados.Diseñado para profesionales y líderes en energías renovables.Este centro te ofrece las herramientas para impulsar tus proyectos.          </p>
