        ...
        < div className = "flex justify-center relative my-20 z-10" >
            <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center" >
                <p className="uppercase tracking-widest text-xs text-center text-blue-100 max-w-80" >
                    BIS Integraciones - ENERGY - CONSULTING
                        </p>

    {/* TextGenerateEffect */ }
    <TextGenerateEffect
            words="Consultoría Integral en Energías Renovables"
    className = "text-center text-[40px] md:text-5xl lg:text-6xl"
        />

        <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl" style = {{ color: 'white' }
} >
    Desde estudios de viabilidad hasta la optimización de sistemas energéticos.                </p>
        < a href = "\contactus" >
            <MagicButton
            title="Contacto"
...
export default Hero_Consulting;