...
const Services_Soluciones: React.FC = () => {
    ...
    const service1 = "/EN_Consul2.jpg"; // Foto principal
    const service2 = "/EN_Granja1.jpg"; // Foto segunda
    const service3 = "/EN_GreenBulb.jpg";
    const check = "/check.svg";
    const brainwaveServices = [
        "Gestión de Proyectos Energéticos",
        "Implementación de Tecnologías Renovables",
    ...
    const brainwaveServices2 = [
        ...
        "Asesoramiento en Energías Limpias",
    ...
    <div className="relative z-1 max-w-[17rem] ml-auto" >
        <h4 className="h4 mb-4" >
            <span className="text-purple" > Proyectos </span> Energéticos
                </h4>
                < p className = "body-2 mb-[3rem] text-n-3" >
                    Gestión integral de proyectos energéticos, implementación de tecnologías renovables hasta la consultoría en eficiencia energética y el desarrollo de infraestructuras verdes
                        </p>
                        < ul className = "body-2" >
                        {
    ...
    <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]" >
        ...
        < div className = "relative z-1 max-w-[17rem] mr-auto" >
            <h4 className="h4 mb-4" >
                <span className="text-purple" > Recursos </span> Sostenibles
                    </h4>
                    < p className = "body-2 mb-[3rem] text-n-3" >
                        Nuestro enfoque integral garantiza la viabilidad económica y el respeto al entorno natural en cada proyecto
                            </p>
                            < ul className = "body-2" >
                            {
            ...
            < div className = "relative z-1 grid gap-5 lg:grid-cols-1" >
                ...
                <div className = "p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]" >
                    <div className="py-12 px-4 xl:px-8" >
                        <h4 className="h4 mb-4" >
                            <span className="text-purple" > Asesoría </span> Integral
                                </h4>
...
export default Services_Soluciones;
