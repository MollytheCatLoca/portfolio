...
import MagicButtonPDF from "@/components/ui/MagicButtonPDF";


const Footer_Energy_Dash = ({ scenarios }) => {
    return (
    ...
    < p className = "text-white-200 md:mt-10 my-5 text-center" >
        Soluciones sostenibles que impulsan un mañana más verde y eficiente.
            ...
            < MagicButtonPDF scenarios = { scenarios } />
...
export default Footer_Energy_Dash;