...
const PowerPage: React.FC<PDFPageProps> = ({ children, pageNumber, totalPages }) => (
    <div style= {{
        width: '297mm',
        height: '210mm',
        position: 'relative',
...
<div style={
    ...
    <div style={ { display: 'flex', alignItems: 'center' } }>
        <img src="/BISLogo.svg" alt = "BIS Logo" style = {{ height: '20mm', marginRight: '5mm', marginTop: '3mm' }} />
            < span style = {{ fontSize: '16px' }}> INTEGRACIONES </span>
                </div>
                < div style = {{ textAlign: 'right' }}>
                    <div style={ { fontSize: '14px', color: '#8a3ab4' } }> PARQUES SOLARES </div>
