    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        <Card
          ...
          des="Colaboraremos para mapear los objetivos de tu proyecto vial, el público objetivo y las funcionalidades clave. Discutiremos aspectos como la estructura del sistema, la integración de tecnologías viales y los requisitos de contenido técnico."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          des="Realizamos la instalación y puesta en marcha de todos los sistemas viales. Nuestro equipo de profesionales se asegura de que cada componente funcione de manera óptima y que el sistema completo esté listo para operar. Además, proporcionamos capacitación integral a tu equipo, garantizando que estén preparados para manejar y mantener el sistema con confianza y eficacia."
        >
          <CanvasRevealEffect
            animationSpeed={3}
