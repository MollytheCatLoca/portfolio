...
const DimensionarForm: React.FC<DimensionarFormProps> = () => {
    ...
    return (
        <div className= "w-full h-[30vh] max-w-full mx-auto p-4 bg-opacity-75 backdrop-blur-lg bg-gray-900 rounded-3xl" >
        {/* Header del Dashboard con 4 valores en una sola línea */ }
        < div className = "flex items-center gap-6 mb-4" >
            <Sun className="h-6 w-6 text-yellow-400" />
                <h2 className="text-2xl font-bold text-white flex-1" > Dimensionar Parque Solar </h2>
                    </div>

    {/* Header en Línea con Valores */ }
    <div className="flex justify-between items-center space-x-4" >
        <div className="flex flex-col items-center bg-gray-800 px-4 py-2 rounded-lg w-1/4" >
            <p className="text-sm font-medium text-gray-200" > Potencia Contratada(kW) </p>
                < Input
    type = "number"
    value = { constants.contractedPower }
    onChange = {(e) => updateConstant('contractedPower', e.target.value)}
className = "bg-gray-700 text-white border-gray-600 text-center w-full mt-1"
min = "0"
step = "10"
    />
    </div>
    ...
    < div className = "flex flex-col items-center bg-gray-800 px-4 py-2 rounded-lg w-1/4" >
        <p className="text-sm font-medium text-gray-200" > Consumo Anual(kWh / año) </p>
            < Input
type = "number"
...
step = "1000"
    ...
    < div className = "flex flex-col items-center bg-gray-800 px-4 py-2 rounded-lg w-1/4" >
        <p className="text-sm font-medium text-gray-200" > Curtailment Máximo(%) </p>
            < Input
type = "number"
...
step = "1"
    ...
    < div className = "flex flex-col items-center bg-gray-800 px-4 py-2 rounded-lg w-1/4" >
        <p className="text-sm font-medium text-gray-200" > Factor de Generación(MWh / MW / año) </p>
            < Input
type = "number"
...
{/* Escala Máxima Slider */ }
<div className="mt-4" >
    <label className="block mb-1 text-sm text-white" > Escala Máxima de Visualización(MW) </label>
        < input
type = "range"
value = { maxCapacity }
...
className = "w-full"
    />
    <div className="text-white text-sm mt-1 text-center" > { maxCapacity } MW </div>
        </div>

{/* Gráfico */ }
<div className="mt-8" style = {{ height: 'calc(100% - 160px)' }}>
...
{/* Aquí puedes agregar las líneas como lo tienes configurado */ }
</ComposedChart>
    </ResponsiveContainer>
    </div>
    </div>
