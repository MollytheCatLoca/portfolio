...
const PowerSummary = ({
    ...
    // Cálculos
    const plantMetricsC = calculatePlantMetrics()
    ...
    const savingsPercentage =
        isNaN(annualSavings / (monthlyMetrics.totalInvoice * 12)) || !isFinite(annualSavings / (monthlyMetrics.totalInvoice * 12))
            ? plantMetrics.selfConsumptionPercentage * 0.79
    ...
    const benefitsList = [
        ...
        },
        {
            ...
            value: formatCurrency(cuotaLeasingMensual).split('.')[0],
            text: 'Cuota Leasing (solo 6 anos)'
        },
        {
