...
const TECHNICAL_FIELDS: Record<keyof TechnicalConstants, string> = {
    contractedPowerKVA: "Potencia Contratada (KVA)",
    contractedPowerKW: "Potencia Contratada (KW)",
    injectionLimitKW: "Límite de Inyección (KW)",
    costPerKW: "Costo por KW",
    referencePowerMW: "Potencia de Referencia (MW)",
    ...
    hoursPico: "Horas Pico",
    hoursValle: "Horas Valle",
    hoursResto: "Horas Resto",
    hoursGeneration: "Horas de Generación"
};
