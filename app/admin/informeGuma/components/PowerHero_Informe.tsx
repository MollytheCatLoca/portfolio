...
const PowerHero_Informe = ({ data }) => {
    const { constants } = useConstants();
    const { subtitle, title, description } = data.heroSection;

    // Generar el texto del botón dinámicamente
    const dynamicButtonText = `Informe Técnico - ${constants?.company?.companyName || ''}`;
...
export default PowerHero_Informe;