...
const DimensionarForm1: React.FC<DimensionarFormProps> = () => {
    ...
    const calculateChartData = useCallback(() => {
        ...
        const capacities = Array.from(
            { length: Math.floor(maxCapacity * 20) + 1 },
            (_, i) => (i * 0.1)
        );
    ...
    // Aquí iría el return...
    return (
        <div className= "w-full max-w-[1020px] mx-auto p-4 rounded-3xl bg-opacity-75 backdrop-blur-lg bg-gray-900" >
        {/* Header row */ }
            ...
            <Sun className="h-6 w-6 text-yellow-400" />
                <h2 className="text-2xl font-bold text-white" > Dimensionar Parque Solar </h2>
                    ...
                    < div className = "flex flex-col gap-4" >
                        {/* Top row with cards and slider */ }
                        < div className = "flex gap-4 flex-wrap md:flex-nowrap" >
                            {/* Variables principales en una fila */ }
                            < div className = "flex gap-4 flex-1 min-w-0" >
                                <Card className="bg-gray-800 border-gray-700 flex-1 min-w-0" >
...
className = "bg-gray-700 text-white border-gray-600 hidden"
    />
