...
function mergeConstants(currentConstants, newData) {
    return {
        technical: {
            ...DEFAULT_CONSTANTS.technical,
            ...currentConstants.technical,
            ...(newData.technical || {})
        },
        consumption: {
            ...DEFAULT_CONSTANTS.consumption,
            ...currentConstants.consumption,
            ...(newData.consumption || {})
        },
        power: {
            ...DEFAULT_CONSTANTS.power,
            ...currentConstants.power,
            ...(newData.power || {})
        },
        invoice: {
            ...DEFAULT_CONSTANTS.invoice,
            ...currentConstants.invoice,
            ...(newData.invoice || {})
        },
        company: {
            ...DEFAULT_CONSTANTS.company,
            ...currentConstants.company,
            ...(newData.company || {})
        },
        detailedMetrics: {
            ...
            valoresAnuales: {
                ...DEFAULT_CONSTANTS.detailedMetrics.valoresAnuales,
                ...currentConstants.detailedMetrics?.valoresAnuales,
                ...(newData.detailedMetrics?.valoresAnuales || {})
            },
            porcentajes: {
                ...DEFAULT_CONSTANTS.detailedMetrics.porcentajes,
                ...currentConstants.detailedMetrics?.porcentajes,
                ...(newData.detailedMetrics?.porcentajes || {})
            }
        }
    };
...
export async function POST(request: Request) {
    try {
        ...
        const updatedConstants = mergeConstants(currentConstants, newData);
