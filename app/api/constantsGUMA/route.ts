...
const constantsFilePath = path.join(process.cwd(), 'app', 'admin', 'informeGuma', 'data', 'constants.json');
...
async function readConstants() {
    try {
        ...
        return {
            ...
            invoiceGuma: { ...DEFAULT_CONSTANTS.invoiceGuma, ...constants.invoiceGuma },
